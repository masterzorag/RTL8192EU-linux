...
)
{
	...
	reg0x18 = phy_query_rf_reg(Adapter, ODM_RF_PATH_A, RF_CHNLBW, bRFRegOffsetMask);


	while (retryNum++ < MaxRetryCount) {
		phy_set_rf_reg(Adapter, ODM_RF_PATH_A, RF_CHNLBW, bRFRegOffsetMask, 0x7C0D); /* CH13 */
	...
	phy_set_rf_reg(Adapter, ODM_RF_PATH_A, RF_CHNLBW, bRFRegOffsetMask, reg0x18); /* restore chnl */
