...
)
{
	...
	/* OFDM HW AntDiv Parameters */
	odm_set_bb_reg(p_dm_odm, 0x8D4, 0x7FF, 0xA0); /* thershold */
	odm_set_bb_reg(p_dm_odm, 0x8D4, 0x7FF000, 0x00); /* bias */
	...
	odm_set_bb_reg(p_dm_odm, 0x8CC, BIT(20) | BIT(19) | BIT(18), 3); /* settling time of antdiv by RF LNA = 100ns */
...
)
{
	...
	/* 2 [--8821C---] */
		...
		phydm_s0s1_sw_ant_div_init_8821c(p_dm_odm);
	}
#endif
