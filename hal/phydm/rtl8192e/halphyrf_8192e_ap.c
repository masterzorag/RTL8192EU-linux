...
)
{
	...
	if ((iqk_result_x != 0) && (*(p_dm_odm->p_band_type) == ODM_BAND_2_4G)) {
		...
		/*if (rf_path == ODM_RF_PATH_A)// Remove this to Fix path B PowerTracking */
		switch (rf_path) {
		case ODM_RF_PATH_A:
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("TxPwrTracking path %c: X = 0x%x, Y = 0x%x ele_A = 0x%x ele_C = 0x%x ele_D = 0x%x 0xeb4 = 0x%x 0xebc = 0x%x\n",
		(rf_path == ODM_RF_PATH_A ? 'A' : 'B'), (u32)iqk_result_x, (u32)iqk_result_y, (u32)ele_A, (u32)ele_C, (u32)ele_D, (u32)iqk_result_x, (u32)iqk_result_y));
}
...
)
{
	if (method == TXAGC) {
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_TxPwrTrackSetPwr92E CH=%d\n", *(p_dm_odm->p_channel)));
#if (DM_ODM_SUPPORT_TYPE & (ODM_WIN | ODM_CE))

#if (MP_DRIVER != 1)
		phy_set_tx_power_level8192e(p_dm_odm->adapter, *p_dm_odm->p_channel);
#else
		pwr = phy_query_bb_reg(adapter, REG_TX_AGC_A_RATE18_06, 0xFF);
		pwr += p_dm_odm->rf_calibrate_info.power_index_offset[RF_PATH_A];
		...
		pwr = phy_query_bb_reg(adapter, REG_TX_AGC_A_RATE18_06, 0xFF);
		pwr += (p_dm_odm->bb_swing_idx_ofdm[RF_PATH_A] - p_dm_odm->bb_swing_idx_ofdm_base[RF_PATH_A]);
		...
		if (!p_dm_odm->rf_calibrate_info.is_cck_in_ch14) {
			odm_write_1byte(p_dm_odm, 0xa22, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][0]);
			odm_write_1byte(p_dm_odm, 0xa23, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][1]);
			odm_write_1byte(p_dm_odm, 0xa24, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][2]);
			odm_write_1byte(p_dm_odm, 0xa25, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][3]);
			odm_write_1byte(p_dm_odm, 0xa26, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][4]);
			odm_write_1byte(p_dm_odm, 0xa27, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][5]);
			odm_write_1byte(p_dm_odm, 0xa28, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][6]);
			odm_write_1byte(p_dm_odm, 0xa29, cck_swing_table_ch1_ch13_92e[p_dm_odm->bb_swing_idx_cck][7]);
		} else {
			odm_write_1byte(p_dm_odm, 0xa22, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][0]);
			odm_write_1byte(p_dm_odm, 0xa23, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][1]);
			odm_write_1byte(p_dm_odm, 0xa24, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][2]);
			odm_write_1byte(p_dm_odm, 0xa25, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][3]);
			odm_write_1byte(p_dm_odm, 0xa26, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][4]);
			odm_write_1byte(p_dm_odm, 0xa27, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][5]);
			odm_write_1byte(p_dm_odm, 0xa28, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][6]);
			odm_write_1byte(p_dm_odm, 0xa29, cck_swing_table_ch14_92e[p_dm_odm->bb_swing_idx_cck][7]);
		}

		/* Adjust BB swing by OFDM IQ matrix */
		if (rf_path == RF_PATH_A) {
			set_iqk_matrix_8192e(p_dm_odm, p_dm_odm->bb_swing_idx_ofdm[RF_PATH_A], RF_PATH_A,
			...
			set_iqk_matrix_8192e(p_dm_odm, p_dm_odm->bb_swing_idx_ofdm[RF_PATH_B], RF_PATH_B,
...
{
	p_config->swing_table_size_cck = CCK_TABLE_SIZE_92E;
	p_config->swing_table_size_ofdm = OFDM_TABLE_SIZE_92E;
	p_config->threshold_iqk = 8;
	p_config->average_thermal_num = AVG_THERMAL_NUM_92E;
	p_config->rf_path_count = 1;
	p_config->thermal_reg_addr = RF_T_METER_92E;

	p_config->odm_tx_pwr_track_set_pwr = odm_tx_pwr_track_set_pwr92_e;
	p_config->do_iqk = do_iqk_8192e;
	p_config->phy_lc_calibrate = phy_lc_calibrate_8192e;
	p_config->get_delta_swing_table = get_delta_swing_table_8192e;
}
#endif
...
)
{
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0x07f77);  /* PA off, default: 0x7f7f */
	...
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_A, MASKDWORD, 0x82140303);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_A, MASKDWORD, 0x68160000);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path A LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	if (!(reg_eac & BIT(28)) &&
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("pathA TX IQK is not success\n"));
...
)
{
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-A Rx IQK modify RXIQK mode table!\n")); */
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xf1173); /* PA off, deafault:0xf117b */

	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G2, RFREGOFFSETMASK, 0xf1173); /* PA off, deafault:0xf117b */

	/*	PA/PAD control by 0x56, and set = 0x0 */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xdf, RFREGOFFSETMASK, 0x980);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x56, RFREGOFFSETMASK, 0x51100);
	...
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_A, MASKDWORD, 0x8216031f);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_A, MASKDWORD, 0x6816031f);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path A LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	if (!(reg_eac & BIT(28)) &&
		...
		odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x000000);
		odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xdf, RFREGOFFSETMASK, 0x180);
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("pathA get TXIMR is not success\n"));
		return result;
	...
	/* 1 RX IQK */
	/* modify RXIQK mode table */
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("Do RXIQK!\n"));
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xf7ff2);  /*PA off : default:0xf7ffa*/

	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G2, RFREGOFFSETMASK, 0xf7ff2);  /*PA off : default:0xf7ffa*/


	/*	PA/PAD control by 0x56, and set = 0x0 */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xdf, RFREGOFFSETMASK, 0x980);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x56, RFREGOFFSETMASK, 0x510e0);
	...
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_A, MASKDWORD, 0x821608ff);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_A, MASKDWORD, 0x281608ff);

	/*	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_A, MASKDWORD, 0x82160cff);
	 *	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_A, MASKDWORD, 0x28160cff); */

	/* LO calibration setting
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("LO calibration setting!\n")); */
	odm_set_bb_reg(p_dm_odm, REG_IQK_AGC_RSP, MASKDWORD, 0x0046a891);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path A LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	if (!(reg_eac & BIT(27)) &&	/*if Tx is OK, check whether Rx is OK*/
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path A Rx IQK is not success!!\n"));
...
)
{
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-B IQK setting!\n")); */
	...
	odm_set_bb_reg(p_dm_odm, 0x820, BIT(8), 0x0);
	...
	/* modify TXIQK mode table */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_RCK_OS, RFREGOFFSETMASK, 0x20000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G2, RFREGOFFSETMASK, 0x07f77);  /* PA off, default: 0x7f7f */

	odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x808000);

#if 0
	odm_set_bb_reg(p_dm_odm, 0xe28, 0xffffff00, 0x000000);
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path A 0xdf = 0x%x\n", odm_get_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xdf, RFREGOFFSETMASK)));
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path B 0xdf = 0x%x\n", odm_get_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0xdf, RFREGOFFSETMASK)));
	odm_set_bb_reg(p_dm_odm, 0xe28, 0xffffff00, 0x808000);
#endif

	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_TONE_A, MASKDWORD, 0x38008c1c);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_TONE_A, MASKDWORD, 0x38008c1c);
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_TONE_B, MASKDWORD, 0x18008c1c);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_TONE_B, MASKDWORD, 0x38008c1c);

	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_B, MASKDWORD, 0x82140303);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_B, MASKDWORD, 0x68160000);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("One shot, path B LOK & IQK!\n")); */
	odm_set_bb_reg(p_dm_odm, REG_IQK_AGC_PTS, MASKDWORD, 0xfa000000);
	odm_set_bb_reg(p_dm_odm, REG_IQK_AGC_PTS, MASKDWORD, 0xf8000000);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path B LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	/*enable path-A PI*/
	odm_set_bb_reg(p_dm_odm, 0x820, BIT(8), 0x1);
	...
	if (!(reg_eac & BIT(31)) &&
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path B TX IQK is not success\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("Get RXIQK TXIMR!\n"));
	/* modify RXIQK mode table
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-B Rx IQK modify RXIQK mode table!\n")); */
	odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x000000);

	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, RF_TXPA_G2, RFREGOFFSETMASK, 0xf1173);  /*PA off, default: 0xf117b*/

	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xf1173);  /*PA off, default: 0xf117b*/

	/*	PA/PAD all off */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0xdf, RFREGOFFSETMASK, 0x980);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x56, RFREGOFFSETMASK, 0x511e0);
	...
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_B, MASKDWORD, 0x8216031f);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_B, MASKDWORD, 0x6816031f);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path B LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	if (!(reg_eac & BIT(31)) &&
		...
		odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x000000);
		odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0xdf, RFREGOFFSETMASK, 0x180);
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("pathB get TXIMR is not success\n"));
		return result;
	}
	...
	/* modify RXIQK mode table
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-B Rx IQK modify RXIQK mode table 2!\n")); */
	odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x000000);
	...
	/*	PA/PAD all off */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0xdf, RFREGOFFSETMASK, 0x980);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x56, RFREGOFFSETMASK, 0x510e0);
	/*	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x56, RFREGOFFSETMASK, 0x51000 ); */
	...
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_TONE_A, MASKDWORD, 0x38008c1c);
	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_TONE_B, MASKDWORD, 0x38008c1c);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_TONE_B, MASKDWORD, 0x18008c1c);

	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_B, MASKDWORD, 0x821608ff);
	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_B, MASKDWORD, 0x281608ff);

	/*	odm_set_bb_reg(p_dm_odm, REG_TX_IQK_PI_B, MASKDWORD, 0x82160cff);
	 *	odm_set_bb_reg(p_dm_odm, REG_RX_IQK_PI_B, MASKDWORD, 0x28160cff); */
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path B LOK & IQK.\n", IQK_DELAY_TIME_92E)); */
	...
	if (!(reg_eac & BIT(30)) &&/*if Tx is OK, check whether Rx is OK*/
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path B Rx IQK is not success!!\n"));
...
)
{
	...
	if (final_candidate == 0xFF)
		...
		if (is_tx_only) {
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_path_a_fill_iqk_matrix_92e only Tx OK\n"));
			return;
		}
...
#if 1
	odm_set_bb_reg(p_dm_odm, 0x520, MASKBYTE2, 0x0);
#else
	for (i = 0 ; i < (IQK_MAC_REG_NUM - 1); i++)
...
)
{
	...
	if (false == is2T) {
		path_on = 0x0fc01616;
		odm_set_bb_reg(p_dm_odm, adda_reg[0], MASKDWORD, 0x0fc01616);
	} else
...
)
{
	...
	*/
#if 1
	odm_set_bb_reg(p_dm_odm, 0x520, MASKBYTE2, 0xff);
#else
	odm_set_bb_reg(p_dm_odm, 0x522, MASKBYTE0, 0x7f);
	odm_set_bb_reg(p_dm_odm, 0x550, MASKBYTE0, 0x15);
	odm_set_bb_reg(p_dm_odm, 0x551, MASKBYTE0, 0x00);
#endif
...
)
{
	...
	odm_set_rf_reg(p_dm_odm, 0x0, 0x0, RFREGOFFSETMASK, 0x10000);
	odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x808000);
}
...
)
{
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_save_adda_registers_92e(p_adapter, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers_92e(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
		_phy_save_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#else
		_phy_save_adda_registers_92e(p_dm_odm, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers_92e(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
		_phy_save_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#endif
	}
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQ Calibration for %s for %d times\n", (is2T ? "2T2R" : "1T1R"), t));
	...
	_phy_path_adda_on_92e(p_adapter, ADDA_REG, true, is2T);
#else
	_phy_path_adda_on_92e(p_dm_odm, ADDA_REG, true, is2T);
#endif
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_pi_mode_switch_92e(p_adapter, true);
#else
		_phy_pi_mode_switch_92e(p_dm_odm, true);
#endif
	}
#endif
	/* BB setting */
	...
	odm_set_bb_reg(p_dm_odm, REG_FPGA0_XCD_RF_INTERFACE_SW, MASKDWORD, 0x55204200);
	...
	if ((p_dm_odm->ext_lna) && !(p_dm_odm->ext_pa)) { /* external LNA / external PA = 1 /0 */
		/* PAPE force to high */
		/* just for high power with external LNA, without external PA */
		odm_set_bb_reg(p_dm_odm, 0x930, 0xf, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x930, 0x0f000000, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x938, 0xf, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x938, 0x0f000000, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x92c, MASKDWORD, 0x00410041);
	} else if (p_dm_odm->ext_pa) { /* external PA = 1 */
		/* PAPE force to low */
		...
		odm_set_bb_reg(p_dm_odm, 0x938, 0xf, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x938, 0x0f000000, 0x7);
		odm_set_bb_reg(p_dm_odm, 0x92c, MASKDWORD, 0x00000000);
	}
	...
	/* MAC settings */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_mac_setting_calibration_92e(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
#else
	_phy_mac_setting_calibration_92e(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
#endif
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQK setting!\n")); */
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		path_aok = phy_path_a_iqk_8192e(p_adapter, is2T);
#else
		path_aok = phy_path_a_iqk_8192e(p_dm_odm, is2T);
#endif
		/*		if(path_aok == 0x03){ */
		if (path_aok == 0x01) {
			...
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path A Tx IQK Fail!!\n"));
			result[t][0] = 0x100;
			result[t][1] = 0x0;
		}
#if 0
	...
	for (i = 0 ; i < retry_count ; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		path_aok = phy_path_a_rx_iqk_92e(p_adapter, is2T);
#else
		path_aok = phy_path_a_rx_iqk_92e(p_dm_odm, is2T);
#endif
		if (path_aok == 0x03) {
	...
	if (is2T) {
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_path_a_stand_by_92e(p_adapter);

		/* Turn ADDA on */
		_phy_path_adda_on_92e(p_adapter, ADDA_REG, false, is2T);
#else
		_phy_path_a_stand_by_92e(p_dm_odm);

		/* Turn ADDA on */
		_phy_path_adda_on_92e(p_dm_odm, ADDA_REG, false, is2T);
#endif
		...
		for (i = 0 ; i < retry_count ; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			path_bok = phy_path_b_iqk_8192e(p_adapter);
#else
			path_bok = phy_path_b_iqk_8192e(p_dm_odm);
#endif
			/*		if(path_bok == 0x03){ */
			if (path_bok == 0x01) {
				...
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path B Tx IQK Fail!!\n"));
				result[t][4] = 0x100;
				result[t][5] = 0x0;
			}
#if 0
		...
		for (i = 0 ; i < retry_count ; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			path_bok = phy_path_b_rx_iqk_92e(p_adapter, is2T);
#else
			path_bok = phy_path_b_rx_iqk_92e(p_dm_odm, is2T);
#endif
			if (path_bok == 0x03) {
	...
	if (t != 0) {
		...
		_phy_reload_adda_registers_92e(p_adapter, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters*/
		_phy_reload_mac_registers_92e(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);

		_phy_reload_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#else
		/* Reload ADDA power saving parameters*/
		_phy_reload_adda_registers_92e(p_dm_odm, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters*/
		_phy_reload_mac_registers_92e(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);

		_phy_reload_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#endif
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_iq_calibrate_8192e() <==\n"));
...
)
{
	...
	if ((tmp_reg & 0x70) != 0) {	/*Deal with contisuous TX case*/
		...
		/* path-B */
		if (is2T)
			odm_set_rf_reg(p_dm_odm, RF_PATH_B, RF_AC, MASK12BITS, rf_bmode);
	} else   /*Deal with Packet TX case*/
 ...
 *	u32			AP_curve[PATH_NUM][APK_CURVE_REG_NUM]; */
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_save_mac_registers_92e(p_adapter, MAC_REG, MAC_backup);

	/*save AFE default value*/
	_phy_save_adda_registers_92e(p_adapter, AFE_REG, AFE_backup, IQK_ADDA_REG_NUM);
#else
	_phy_save_mac_registers_92e(p_dm_odm, MAC_REG, MAC_backup);

	/*save AFE default value*/
	_phy_save_adda_registers_92e(p_dm_odm, AFE_REG, AFE_backup, IQK_ADDA_REG_NUM);
#endif
	...
	for (path = 0; path < pathbound; path++) {
		...
		/* MAC settings */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_mac_setting_calibration_92e(p_adapter, MAC_REG, MAC_backup);
#else
		_phy_mac_setting_calibration_92e(p_dm_odm, MAC_REG, MAC_backup);
#endif
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_reload_mac_registers_92e(p_adapter, MAC_REG, MAC_backup);
#else
	_phy_reload_mac_registers_92e(p_dm_odm, MAC_REG, MAC_backup);
#endif
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_reload_adda_registers_92e(p_adapter, AFE_REG, AFE_backup, IQK_ADDA_REG_NUM);
#else
	_phy_reload_adda_registers_92e(p_dm_odm, AFE_REG, AFE_backup, IQK_ADDA_REG_NUM);
#endif
...
)
{
	...
	*/
...
#else /*for ODM_WIN*/
	if (is_recovery &&
	    (!p_adapter->is_in_hct_test)) /*YJ,add for PowerTest,120405*/
#endif
	{
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("PHY_IQCalibrate_92E: Return due to is_recovery!\n"));
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_reload_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#else
		_phy_reload_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#endif
		return;
	}
	...
	for (i = 0; i < 3; i++) {
		...
		_phy_iq_calibrate_8192e(p_adapter, result, i, true);
		/*	 		_phy_iq_calibrate_8192e(p_adapter, result, i, false); */

#else

		/*	 		_phy_iq_calibrate_8192e(p_dm_odm, result, i, false); */
		_phy_iq_calibrate_8192e(p_dm_odm, result, i, true);
#endif


		if (i == 1) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			is12simular = phy_simularity_compare_8192e(p_adapter, result, 0, 1);
#else
			is12simular = phy_simularity_compare_8192e(p_dm_odm, result, 0, 1);
#endif
		...
		if (i == 2) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			is13simular = phy_simularity_compare_8192e(p_adapter, result, 0, 2);
#else
			is13simular = phy_simularity_compare_8192e(p_dm_odm, result, 0, 2);
#endif
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			is23simular = phy_simularity_compare_8192e(p_adapter, result, 1, 2);
#else
			is23simular = phy_simularity_compare_8192e(p_dm_odm, result, 1, 2);
#endif
	...
	if (final_candidate != 0xff) {
		priv->pshare->rege94 = p_dm_odm->rf_calibrate_info.rege94 = rege94 = result[final_candidate][0];
		priv->pshare->rege9c = p_dm_odm->rf_calibrate_info.rege9c = rege9c = result[final_candidate][1];
		...
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQK: TX0_X=%x TX0_Y=%x RX0_X=%x RX0_Y=%x TX1_X=%x TX1_Y=%x RX1_X=%x RX1_Y=%x\n ", rege94, rege9c, regea4, regeac, regeb4, regebc, regec4, regecc));
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_path_a_fill_iqk_matrix_92e(p_adapter, is_patha_ok, result, final_candidate, (regea4 == 0));
#else
		_phy_path_a_fill_iqk_matrix_92e(p_dm_odm, is_patha_ok, result, final_candidate, (regea4 == 0));
#endif
	}
	...
	if ((regeb4 != 0)/*&&(regec4 != 0)*/) {
		 ...
		 *	{ */
		_phy_path_b_fill_iqk_matrix_92e(p_adapter, is_pathb_ok, result, final_candidate, (regec4 == 0));
		/*	} */
#else
		_phy_path_b_fill_iqk_matrix_92e(p_dm_odm, is_pathb_ok, result, final_candidate, (regec4 == 0));
#endif
	}
	...
	_phy_save_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#else
	_phy_save_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, IQK_BB_REG_NUM);
#endif
...
)
{
	...
	if (IS_2T2R(p_hal_data->version_id))
		_phy_lc_calibrate_8192e(p_adapter, true);
	else
#endif
	{
		/* For 88C 1T1R */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_lc_calibrate_8192e(p_adapter, false);
#else
		_phy_lc_calibrate_8192e(p_dm_odm, false);
#endif
	}
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	if (IS_92C_SERIAL(p_hal_data->version_id))
		_phy_ap_calibrate_8192e(p_adapter, delta, true);
	else
#endif
	{
		/* For 88C 1T1R */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_ap_calibrate_8192e(p_adapter, delta, false);
#else
		_phy_ap_calibrate_8192e(p_dm_odm, delta, false);
#endif
	}
}
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	if (IS_92C_SERIAL(p_hal_data->version_id))
		_phy_set_rf_path_switch_8192e(p_adapter, is_main, true);
	else
#endif
	{
		/* For 88C 1T1R */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_set_rf_path_switch_8192e(p_adapter, is_main, false);
#else
		_phy_set_rf_path_switch_8192e(p_dm_odm, is_main, false);
#endif
	}
}
...
void
_phy_digital_predistortion_92e(
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	struct _ADAPTER	*p_adapter,
#else
	struct PHY_DM_STRUCT	*p_dm_odm,
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==>_phy_digital_predistortion_92e()\n"));

	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_digital_predistortion_92e for %s %s\n", (is2T ? "2T2R" : "1T1R")));
	...
	/* save MAC default value */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_save_mac_registers_92e(p_adapter, BB_REG, MAC_backup);
#else
	_phy_save_mac_registers_92e(p_dm_odm, BB_REG, MAC_backup);
#endif
	...
	while (retry_count < DP_RETRY_LIMIT && !p_dm_odm->rf_calibrate_info.is_dp_path_aok) {
		...
		if (tmp_reg < 0xf0 || tmp_reg > 0x105 || tmp_reg2 > 0xff) {
			...
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path A DPK Success\n"));
...
void
phy_digital_predistortion_8192e(
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	struct _ADAPTER	*p_adapter
#else
	struct PHY_DM_STRUCT	*p_dm_odm
...
)
{
	...
	if (IS_92C_SERIAL(p_hal_data->version_id))
		_phy_digital_predistortion_92e(p_adapter, true);
	else
#endif
	{
		/* For 88C 1T1R */
		_phy_digital_predistortion_92e(p_adapter, false);
	}
}
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	if (IS_2T2R(p_hal_data->version_id))
		return _phy_query_rf_path_switch_8192e(p_adapter, true);
	else
#endif
	{
		/* For 88C 1T1R */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		return _phy_query_rf_path_switch_8192e(p_adapter, false);
#else
		return _phy_query_rf_path_switch_8192e(p_dm_odm, false);
#endif
	}
}
#endif
