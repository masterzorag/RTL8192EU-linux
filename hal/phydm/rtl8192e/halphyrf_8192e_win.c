...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("pwr_tracking_limit_cck=%d      pwr_tracking_limit_ofdm=%d\n", pwr_tracking_limit_cck, pwr_tracking_limit_ofdm));
	...
	if (method == TXAGC) {
		...
		if (rf_path == ODM_RF_PATH_A) {
			...
			PHY_SetTxPowerIndexByRateSection(adapter, ODM_RF_PATH_A, *p_dm_odm->p_channel, HT_MCS8_MCS15);
		} else {
			PHY_SetTxPowerIndexByRateSection(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, CCK);
			PHY_SetTxPowerIndexByRateSection(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, OFDM);
			PHY_SetTxPowerIndexByRateSection(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, HT_MCS0_MCS7);
			PHY_SetTxPowerIndexByRateSection(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, HT_MCS8_MCS15);
		}
#else
		...
		if (rf_path == ODM_RF_PATH_A) {
			...
			pwr += p_rf_calibrate_info->power_index_offset[ODM_RF_PATH_B];
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("Power Tracking tx_rate=0x%X\n", tx_rate));
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("Call get_delta_swing_table_8192e Power Tracking tx_rate=0x%X\n", tx_rate));
...
)
{
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_save_adda_registers_92e(p_adapter, ADDA_REG, p_rf_calibrate_info->ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers_92e(p_adapter, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);
		_phy_save_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup, IQK_BB_REG_NUM);
#else
		_phy_save_adda_registers_92e(p_dm_odm, ADDA_REG, p_rf_calibrate_info->ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers_92e(p_dm_odm, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);
		_phy_save_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup, IQK_BB_REG_NUM);
#endif
	}
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQ Calibration for %s for %d times\n", (is2T ? "2T2R" : "1T1R"), t));
	...
	/* MAC settings */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_mac_setting_calibration_92e(p_adapter, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);
#else
	_phy_mac_setting_calibration_92e(p_dm_odm, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);
#endif
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQK setting!\n")); */
	...
	if (t != 0) {
		...
		_phy_reload_adda_registers_92e(p_adapter, ADDA_REG, p_rf_calibrate_info->ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters*/
		_phy_reload_mac_registers_92e(p_adapter, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);

		_phy_reload_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup, IQK_BB_REG_NUM);
#else
		/* Reload ADDA power saving parameters*/
		_phy_reload_adda_registers_92e(p_dm_odm, ADDA_REG, p_rf_calibrate_info->ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters*/
		_phy_reload_mac_registers_92e(p_dm_odm, IQK_MAC_REG, p_rf_calibrate_info->IQK_MAC_backup);

		_phy_reload_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup, IQK_BB_REG_NUM);
#endif
...
)
{
...
#else /*for ODM_WIN*/
	if (is_recovery &&
	    (!p_adapter->bInHctTest)) /*YJ,add for PowerTest,120405*/
#endif
	{
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("PHY_IQCalibrate_92E: Return due to is_recovery!\n"));
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_reload_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup_recover, 9);
#else
		_phy_reload_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup_recover, 9);
#endif
		return;
	}
	...
	_phy_save_adda_registers_92e(p_adapter, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup_recover, 9);
#else
	_phy_save_adda_registers_92e(p_dm_odm, IQK_BB_REG_92C, p_rf_calibrate_info->IQK_BB_backup_recover, IQK_BB_REG_NUM);
#endif
...
#if MP_DRIVER == 1
	bSingleTone = p_mpt_ctx->bSingleTone;
	bCarrierSuppression = p_mpt_ctx->bCarrierSuppression;
#endif
...
)
{
	...
	/* MAIN: WiFi */
	u32 reg = PHY_QueryMacReg(p_adapter, 0x64, MASKDWORD);
	reg &= 0xFFFFF000;
	reg = (is_main) ? (reg | 0x00000100) : (reg | 0x00000004);
	PHY_SetMacReg(p_adapter, 0x64, MASKDWORD, reg);
