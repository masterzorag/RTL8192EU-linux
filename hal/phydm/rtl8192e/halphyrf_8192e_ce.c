...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("===>ODM_TxPwrTrackSetPwr8192EA\n"));
	...
	if (method == TXAGC) {
		...
		if (p_dm_odm->mp_mode == true) {
			if (rf_path == ODM_RF_PATH_A) {
				...
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_tx_pwr_track_set_pwr92_e: CCK Tx-rf(A) Power = 0x%x\n", tx_agc));
				...
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_tx_pwr_track_set_pwr92_e: OFDM Tx-rf(A) Power = 0x%x\n", tx_agc));
			} else if (rf_path == ODM_RF_PATH_B) {
				/* CCK path B */
				pwr = phy_query_bb_reg(adapter, REG_TX_AGC_B_RATE18_06, 0xFF);
				pwr += p_dm_odm->rf_calibrate_info.power_index_offset[ODM_RF_PATH_B];
				...
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_tx_pwr_track_set_pwr92_e: CCK Tx-rf(B) Power = 0x%x\n", pwr));

				/* OFDM path B */
				pwr = phy_query_bb_reg(adapter, REG_TX_AGC_B_RATE18_06, 0xFF);
				pwr += (p_rf_calibrate_info->bb_swing_idx_ofdm[ODM_RF_PATH_B] - p_rf_calibrate_info->bb_swing_idx_ofdm_base[ODM_RF_PATH_B]);
				tx_agc = ((pwr << 24) | (pwr << 16) | (pwr << 8) | pwr);
				...
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_tx_pwr_track_set_pwr92_e: OFDM Tx-rf(B) Power = 0x%x\n", tx_agc));
			}
		} else
#endif
		{
			/* PHY_SetTxPowerLevelByPath8192E(adapter, p_hal_data->current_channel, rf_path);   */ /* Using new set power function */
			...
			if (rf_path == ODM_RF_PATH_A) {
				...
				phy_set_tx_power_index_by_rate_section(adapter, ODM_RF_PATH_A, *p_dm_odm->p_channel, HT_MCS8_MCS15);
			} else {
				phy_set_tx_power_index_by_rate_section(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, CCK);
				phy_set_tx_power_index_by_rate_section(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, OFDM);
				phy_set_tx_power_index_by_rate_section(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, HT_MCS0_MCS7);
				phy_set_tx_power_index_by_rate_section(adapter, ODM_RF_PATH_B, *p_dm_odm->p_channel, HT_MCS8_MCS15);
			}
		}
		...
		if (rf_path == ODM_RF_PATH_A) {
			set_iqk_matrix_8192e(p_dm_odm, final_ofdm_swing_index, ODM_RF_PATH_A,
			...
			set_iqk_matrix_8192e(p_dm_odm, final_ofdm_swing_index, ODM_RF_PATH_B,
		...
		if (rf_path == ODM_RF_PATH_A) {
			...
			if (final_ofdm_swing_index > pwr_tracking_limit_ofdm) {   /*BBSwing higher then Limit*/
				...
				set_iqk_matrix_8192e(p_dm_odm, pwr_tracking_limit_ofdm, ODM_RF_PATH_A,
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][0],
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][1]);
				...
				set_iqk_matrix_8192e(p_dm_odm, 0, ODM_RF_PATH_A,
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][0],
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][1]);
		...
		if (rf_path == ODM_RF_PATH_B) {
			if (final_ofdm_swing_index > pwr_tracking_limit_ofdm) {  /*BBSwing higher then Limit*/
				...
				set_iqk_matrix_8192e(p_dm_odm, pwr_tracking_limit_ofdm, ODM_RF_PATH_B,
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][4],
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][5]);
				...
				set_iqk_matrix_8192e(p_dm_odm, 0, ODM_RF_PATH_B,
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][4],
					p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][5]);
...
)
{
	...
	p_config->rf_path_count = MAX_PATH_NUM_8192E;
...
)
{
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-A Rx IQK modify RXIQK mode table!\n")); */
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x56, RFREGOFFSETMASK, 0x511e0);
	...
	struct _ADAPTER		*adapter)
{
	...
	if (rtw_is_drv_stopped(padapter) || adapter->is_driver_is_going_to_pnp_set_power_sleep || rt_state == eRfOff) {
		ODM_RT_TRACE(p_dm_odm, COMP_INIT, DBG_LOUD, ("odm_check_power_status Return false, due to drv_stop:%s /%d/%d\n",
			? "True" : "False", adapter->is_driver_is_going_to_pnp_set_power_sleep, rt_state));
		return	false;
	}
#endif
	return	true;
...
)
{
	...
	*/
	...
	/*	odm_set_bb_reg(p_dm_odm, 0x550, 0x0000ffff, 0x0015); */
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_path_b_stand_by_92e(p_adapter);

		/* Turn  ADDA on */
		_phy_path_adda_on_92e(p_adapter, ADDA_REG, false, is2T);
#else
		_phy_path_b_stand_by_92e(p_dm_odm);
...
#else
			phy_set_bb_reg(p_dm_odm, REG_CONFIG_PMPD_ANT_B, MASKDWORD, 0x12680000);
#endif
...
)
{
	...
	/* MAIN: WiFi */
	u32 reg = odm_get_mac_reg(p_dm_odm, 0x64, MASKDWORD);
	reg &= 0xFFFFF000;
	reg = (is_main) ? (reg | 0x00000100) : (reg | 0x00000004);
	odm_set_mac_reg(p_dm_odm, 0x64, MASKDWORD, reg);
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_digital_predistortion_92e for %s\n", (is2T ? "2T2R" : "1T1R")));
...
)
{
	...
	if (odm_get_mac_reg(p_dm_odm, 0x64, 0xFFF) == 0x100)
		return true;
	else
		return false;
